<!--
title: 'Serverless Framework Python Flask API backed by DynamoDB on AWS with JWT'
description: 'This template demonstrates how to develop and deploy a simple Python Flask API service backed by DynamoDB running on AWS Lambda using the traditional Serverless Framework and JWT tokens for API security.'
layout: Doc
framework: v3
platform: AWS
language: Python
